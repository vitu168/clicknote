...
const kpiCards = [
  { label: 'Total Visitors', value: '8,400', change: '+6.3%', icon: Users, color: 'bg-accent-50 text-accent-600' },
            ...
            <tbody className="divide-y divide-slate-50 dark:divide-slate-700">
              {[
                ...
                <tr key={row.page} className="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                  <td className="px-6 py-3.5 font-mono text-sm text-accent-600 dark:text-accent-400">{row.page}</td>
