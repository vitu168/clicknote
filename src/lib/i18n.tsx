...
const translations = {
  en: {
    ...
    'note.write_placeholder': 'Start writing…',
    'note.updated':         'Updated',
    'note.saved':           '✓ Saved',
    'note.saving':          'Saving…',
    'note.save_changes':    'Save changes',
    'note.title_required':  'Title is required.',
    'note.favorite_badge':  'Favorite',
    'note.unfavorite_title':'Unfavorite',
    'note.favorite_title':  'Favorite',
    'note.archive_title':   'Archive',
    'note.delete_title':    'Delete',
    'note.delete_confirm':  'Delete this note permanently?',
    'note.restore_title':   'Restore from archive',
    'note.open':            'Open',
    'note.details':         'Details',
    'note.created':         'Created',
    'note.last_updated':    'Last updated',
    'note.words':           'Words',
    'note.characters':      'Characters',
    'note.note_id':         'Note ID',
    'note.actions':         'Actions',
    'note.untitled_note':   'Untitled note',
    // ── NoteForm ──
    'form.edit_note':       'Edit Note',
    'form.new_note':        'New Note',
    'form.edit_subtitle':   'Make changes to your note',
    'form.new_subtitle':    'Capture your idea',
    'form.close':           'Close',
    'form.title_label':     'Title',
    'form.title_required':  'Title is required.',
    'form.title_placeholder': "What's this note about?",
    'form.desc_label':      'Description',
    'form.desc_placeholder': 'Add details, ideas, or anything you want to remember…',
    'form.tip':             'Your note will appear in the list once saved.',
    'form.cancel':          'Cancel',
    'form.saving':          'Saving…',
    'form.error_generic':   'Something went wrong.',
    // ── NoteCard status badges ──
    'badge.favorite':  'Favorite',
    'badge.note':      'Note',
    'badge.untitled':  'Untitled',
    'badge.active':    'Active',
    'badge.inactive':  'Inactive',
    // ── Notifications page ──
    'notif_page.unread':       'unread',
    'notif_page.all_caught_up':'All caught up',
    'notif_page.demo':         '+ Demo',
    'notif_page.mark_all_read':'Mark all read',
    'notif_page.clear_all':    'Clear all',
    'notif_page.empty':        'No notifications yet.',
    'notif_page.empty_hint':   'New activity will show up here as it happens.',
    'notif_page.mark_read':    'Mark as read',
    'notif_page.dismiss':      'Dismiss',
    'notif_page.demo_title':   'New activity',
    'notif_page.demo_body':    'This is a sample notification — real events will appear here.',
    // ── Analytics page ──
    'analytics.kpi_visitors':  'Total Visitors',
    'analytics.kpi_views':     'Page Views',
    'analytics.kpi_conversions':'Conversions',
    'analytics.kpi_bounce':    'Bounce Rate',
    'analytics.this_month':    'this month',
    'analytics.top_pages':     'Top Pages',
    'analytics.top_pages_sub': 'Most visited pages this month',
    'analytics.col_page':      'Page',
    'analytics.col_views':     'Views',
    'analytics.col_unique':    'Unique',
    'analytics.col_avg_time':  'Avg. Time',
    // ── Analytics charts ──
    'analytics.monthly_traffic':    'Monthly Traffic',
    'analytics.visitors_vs_views':  'Visitors vs Page Views',
    'analytics.visitors':           'Visitors',
    'analytics.page_views':         'Page Views',
    'analytics.traffic_sources':    'Traffic Sources',
    'analytics.month_breakdown':    'This month breakdown',
    'analytics.traffic_center':     'Traffic',
    'analytics.weekly_views':       'Weekly Page Views',
    'analytics.last_7_days':        'Last 7 days',
    // ── Sidebar / Header inline labels ──
    'header.theme':    'Theme',
    'header.language': 'Language',
    // ── Sidebar sign-out dialog ──
    'sidebar.sign_out_title': 'Sign out',
    'sidebar.sign_out_desc':  "You'll need to sign in again to access your workspace.",
    'sidebar.sign_out_label': 'Sign out',
    // ── Calendar inline suffix ──
  ...
  km: {
    ...
    'table.joined':      'ចូលរួម',
    // ── Note detail page ──
    'note.back':            'ត្រឡប់ទៅកំណត់ចំណាំ',
    'note.title_placeholder': 'ចំណងជើងកំណត់ចំណាំ',
    'note.write_placeholder': 'ចាប់ផ្ដើមសរសេរ…',
    'note.updated':         'ធ្វើបច្ចុប្បន្នភាព',
    'note.saved':           '✓ បានរក្សា',
    'note.saving':          'កំពុងរក្សា…',
    'note.save_changes':    'រក្សាទុកការផ្លាស់ប្ដូរ',
    'note.title_required':  'ចំណងជើងត្រូវការ',
    'note.favorite_badge':  'ចូលចិត្ត',
    'note.unfavorite_title':'យកចេញពីចំណូលចិត្ត',
    'note.favorite_title':  'ដាក់ក្នុងចំណូលចិត្ត',
    'note.archive_title':   'ទុកក្នុងប័ណ្ណសារ',
    'note.delete_title':    'លុប',
    'note.delete_confirm':  'លុបកំណត់ចំណាំនេះជាអចិន្ត្រៃយ៍?',
    'note.restore_title':   'យកចេញពីប័ណ្ណសារ',
    'note.open':            'បើក',
    'note.details':         'ព័ត៌មានលម្អិត',
    'note.created':         'បានបង្កើត',
    'note.last_updated':    'ធ្វើបច្ចុប្បន្នភាពចុងក្រោយ',
    'note.words':           'ពាក្យ',
    'note.characters':      'តួអក្សរ',
    'note.note_id':         'លេខសម្គាល់',
    'note.actions':         'សកម្មភាព',
    'note.untitled_note':   'កំណត់ចំណាំគ្មានចំណងជើង',
    // ── NoteForm ──
    'form.edit_note':       'កែប្រែកំណត់ចំណាំ',
    'form.new_note':        'កំណត់ចំណាំថ្មី',
    'form.edit_subtitle':   'កែប្រែកំណត់ចំណាំ',
    'form.new_subtitle':    'ចាប់យកគំនិតរបស់អ្នក',
    'form.close':           'បិទ',
    'form.title_label':     'ចំណងជើង',
    'form.title_required':  'ចំណងជើងត្រូវការ',
    'form.title_placeholder': 'កំណត់ចំណាំនេះអំពីអ្វី?',
    'form.desc_label':      'ការពិពណ៌នា',
    'form.desc_placeholder': 'បន្ថែមព័ត៌មានលំអិត គំនិត ឬអ្វីដែលអ្នកចង់ចងចាំ…',
    'form.tip':             'កំណត់ចំណាំរបស់អ្នកនឹងបង្ហាញក្នុងបញ្ជីនៅពេលរក្សាទុក',
    'form.cancel':          'បោះបង់',
    'form.saving':          'កំពុងរក្សា…',
    'form.error_generic':   'មានអ្វីមួយខុស',
    // ── NoteCard status badges ──
    'badge.favorite':  'ចូលចិត្ត',
    'badge.note':      'កំណត់ចំណាំ',
    'badge.untitled':  'គ្មានចំណងជើង',
    'badge.active':    'សកម្ម',
    'badge.inactive':  'អសកម្ម',
    // ── Notifications page ──
    'notif_page.unread':       'មិនទានអាន',
    'notif_page.all_caught_up':'ទាន់ទាំងអស់',
    'notif_page.demo':         '+ គំរូ',
    'notif_page.mark_all_read':'សម្គាល់ទាំងអស់ថាបានអាន',
    'notif_page.clear_all':    'លុបទាំងអស់',
    'notif_page.empty':        'មិនទានមានការជូនដំណឹង',
    'notif_page.empty_hint':   'សកម្មភាពថ្មីនឹងបង្ហាញទីនេះ',
    'notif_page.mark_read':    'សម្គាល់ថាបានអាន',
    'notif_page.dismiss':      'ច្រានចោល',
    'notif_page.demo_title':   'សកម្មភាពថ្មី',
    'notif_page.demo_body':    'នេះជាការជូនដំណឹងគំរូ — ព្រឹត្តិការណ៍ពិតនឹងបង្ហាញទីនេះ',
    // ── Analytics page ──
    'analytics.kpi_visitors':  'ភ្ញៀវវចូលសរុប',
    'analytics.kpi_views':     'ការមើលទំព័រ',
    'analytics.kpi_conversions':'ការបំប្លែង',
    'analytics.kpi_bounce':    'អត្រាចាកចេញ',
    'analytics.this_month':    'ខែនេះ',
    'analytics.top_pages':     'ទំព័រពេញនិយម',
    'analytics.top_pages_sub': 'ទំព័រដែលបានចូលមើលច្រើនបំផុតខែនេះ',
    'analytics.col_page':      'ទំព័រ',
    'analytics.col_views':     'ការមើល',
    'analytics.col_unique':    'តែមួយ',
    'analytics.col_avg_time':  'ពេលវេលាជាមធ្យម',
    // ── Analytics charts ──
    'analytics.monthly_traffic':    'ចរាចរណ៍ប្រចាំខែ',
    'analytics.visitors_vs_views':  'ភ្ញៀវវចូលធៀបនឹងការមើលទំព័រ',
    'analytics.visitors':           'ភ្ញៀវវចូល',
    'analytics.page_views':         'ការមើលទំព័រ',
    'analytics.traffic_sources':    'ប្រភពចរាចរណ៍',
    'analytics.month_breakdown':    'ការបែងចែកខែនេះ',
    'analytics.traffic_center':     'ចរាចរណ៍',
    'analytics.weekly_views':       'ការមើលទំព័រប្រចាំសប្ដាហ៍',
    'analytics.last_7_days':        '៧ថ្ងៃចុងក្រោយ',
    // ── Sidebar / Header inline labels ──
    'header.theme':    'ស្បែក',
    'header.language': 'ភាសា',
    // ── Sidebar sign-out dialog ──
    'sidebar.sign_out_title': 'ចាកចេញ',
    'sidebar.sign_out_desc':  'អ្នកត្រូវចូលម្ដងទៀតដើម្បីចូលប្រើប្រាស់',
    'sidebar.sign_out_label': 'ចាកចេញ',
    // ── Calendar inline suffix ──
    'calendar.this_month': 'ខែនេះ',
    // ── Misc ──
